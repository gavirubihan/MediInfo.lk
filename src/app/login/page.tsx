  ...
  const SocialButtons = ({ isMedical = false }) => (
    <>
      <div className="flex items-center gap-4 my-6">
        ...
        <div className="text-[12px] uppercase tracking-widest font-bold text-mid-gray">Or continue with</div>
        <div className="h-px bg-light-gray flex-1" />
      </div>
      ...
      <div className="flex gap-3">
        ...
        >
          ...
          <span className="text-[14px] font-bold text-dark-gray">Google</span>
        </button>
        <button 
          onClick={() => {
            if (isMedical) setView('signup-med-2');
        ...
        >
          ...
          <span className="text-[14px] font-bold text-dark-gray">Facebook</span>
        </button>
      </div>
    </>
  );
        ...
        <div className="hidden lg:flex flex-1 relative bg-blue overflow-hidden flex-col justify-between px-12 pt-32 pb-12 lg:px-20 lg:pt-40 lg:pb-20">
          ...
          <div className="relative z-10 max-w-lg mb-10">
            <h1 className="text-white text-[42px] font-extrabold font-plus-jakarta leading-[1.1] mb-6">
              {view === 'login' ? 'Welcome back to your health hub.' : 'Join Sri Lanka\'s top medical database.'}
            </h1>
            <p className="text-white/80 text-[18px] leading-relaxed font-medium">
              Whether you are looking for accurate medical data or you are a professional verifying prescriptions, MediInfo.LK is your trusted platform.
            </p>
          </div>
          ...
          <div className="relative z-10 flex gap-4">
            ...
            <div className="flex flex-col justify-center ml-2">
              <div className="text-white text-sm font-bold">10,000+ Verified Staff</div>
              <div className="text-white/70 text-xs">Doctors & Pharmacists</div>
            </div>
          </div>
        </div>
          ...
          <div className="w-full max-w-[440px] bg-white rounded-[24px] shadow-[0_8px_40px_rgba(0,0,0,0.06)] p-8 sm:p-10 animate-fade-up border border-light-gray/50 my-auto mt-auto sm:mt-auto">
            ...
            {view === 'login' && (
              <div className="animate-fade-up">
                <div className="text-center mb-8">
                  <h2 className="text-[28px] font-extrabold font-plus-jakarta text-near-black mb-2 tracking-tight">Sign In</h2>
                  <p className="text-[15px] text-mid-gray">Enter your details to access your account</p>
                </div>
                <form className="flex flex-col gap-5" onSubmit={(e) => { e.preventDefault(); setView('success'); }}>
                  <div>
                    <label className="block text-[13px] font-bold text-dark-gray uppercase tracking-wide mb-1.5">Email Address</label>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1.5">
                      <label className="block text-[13px] font-bold text-dark-gray uppercase tracking-wide">Password</label>
                      <Link href="#" className="text-[13px] font-bold text-blue hover:underline">Forgot?</Link>
                    </div>
                    <div className="relative">
                  ...
                  <Button variant="primary" className="w-full justify-center py-4 rounded-xl text-[15px] shadow-[0_4px_12px_rgba(26,111,191,0.2)] hover:shadow-[0_6px_20px_rgba(26,111,191,0.3)] mt-2 font-bold group">
                    Sign In <ArrowRight size={18} className="ml-1 group-hover:translate-x-1 transition-transform" />
                  </Button>
                </form>
                <SocialButtons />
                <div className="text-center mt-8 text-[14px] text-dark-gray">
                  Don't have an account? <button onClick={() => setView('signup-select')} className="font-bold text-blue hover:underline cursor-pointer bg-transparent border-none p-0">Sign Up</button>
                </div>
              </div>
            )}
            ...
            {view === 'signup-select' && (
              <div className="animate-fade-up">
                <button onClick={() => setView('login')} className="flex items-center text-[13px] font-bold text-mid-gray hover:text-dark-gray mb-6 transition-colors bg-transparent border-none cursor-pointer p-0">
                  <ChevronLeft size={16} className="mr-0.5" /> Back to Login
                </button>
                <div className="text-center mb-8">
                  <h2 className="text-[28px] font-extrabold font-plus-jakarta text-near-black mb-2 tracking-tight">Create Account</h2>
                  <p className="text-[15px] text-mid-gray">How would you like to use MediInfo?</p>
                </div>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="font-bold text-[16px] text-near-black mb-0.5">Normal User</h3>
                        <p className="text-[13px] text-dark-gray">Search medicines, read articles, and manage your health.</p>
                      </div>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="font-bold text-[16px] text-near-black mb-0.5">Medical Staff</h3>
                        <p className="text-[13px] text-dark-gray">Doctors, Pharmacists. Requires SLMC verification.</p>
                      </div>
            ...
            {view === 'signup-normal' && (
              <div className="animate-fade-up">
                ...
                <div className="text-center mb-8">
                  <h2 className="text-[28px] font-extrabold font-plus-jakarta text-near-black mb-2 tracking-tight">Normal Sign Up</h2>
                  <p className="text-[15px] text-mid-gray">Create an account to track your health.</p>
                </div>
                <form className="flex flex-col gap-5" onSubmit={(e) => { e.preventDefault(); setView('success'); }}>
                  <div>
                    <label className="block text-[13px] font-bold text-dark-gray uppercase tracking-wide mb-1.5">Full Name</label>
                    <div className="relative">
                  ...
                  <div>
                    <label className="block text-[13px] font-bold text-dark-gray uppercase tracking-wide mb-1.5">Password</label>
                    <div className="relative">
                      <div className="absolute left-4 top-1/2 -translate-y-1/2 text-mid-gray pointer-events-none"><Lock size={18} /></div>
                  ...
                  <Button variant="primary" className="w-full justify-center py-4 rounded-xl text-[15px] shadow-[0_4px_12px_rgba(26,111,191,0.2)] mt-2 font-bold group">
                    Create Account <ArrowRight size={18} className="ml-1 group-hover:translate-x-1 transition-transform" />
                  </Button>
                </form>
                <SocialButtons />
              </div>
            ...
            {view === 'signup-med-1' && (
              <div className="animate-fade-up">
                ...
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-[28px] font-extrabold font-plus-jakarta text-near-black mb-2 tracking-tight">Staff Details</h2>
                  <p className="text-[15px] text-mid-gray">Step 1 of 2: Your basic information.</p>
                </div>
                <form className="flex flex-col gap-5" onSubmit={(e) => { e.preventDefault(); setView('signup-med-2'); }}>
                  ...
                  <div>
                    <label className="block text-[13px] font-bold text-dark-gray uppercase tracking-wide mb-1.5">Professional Email</label>
                    <div className="relative">
                      <div className="absolute left-4 top-1/2 -translate-y-1/2 text-mid-gray pointer-events-none"><Mail size={18} /></div>
